...
public class Student implements Serializable {
    ...
    public void addStudyPoint(String DESCRIPTION, Integer MAXVAL, Integer SCORE){
        Studypoint point = new Studypoint(DESCRIPTION, MAXVAL, SCORE);
        this.studypointCollection.add(point);
